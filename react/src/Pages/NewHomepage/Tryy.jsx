  ...
  return (
    <div className='bodystyle'>
      ...
      <a className="menu-item">
        <span><i className="uil uil-chart-line"></i></span> <h3>Analytics</h3><span></span>
      </a>
      <a
        id="theme"
      ...
      >
        <span><i className="uil uil-compass"></i></span><h3>Theme</h3>
      </a>
      <a className="menu-item">
        <span><i className="uil uil-setting"></i></span> <h3>Settings</h3><span></span>
      </a>    
                     {/* End Sidebar */}
      <label htmlFor="create-post" className="btn btn-primary">Log out</label>
    </div>
    </div>
                     {/* END LEFT */}
