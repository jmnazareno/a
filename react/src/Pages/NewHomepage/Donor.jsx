...
import "./Tryy.css"
import { AutoGraphOutlined, BookmarkBorderOutlined, ColorLensOutlined, HomeOutlined, NotificationsOutlined, SettingsOutlined } from '@mui/icons-material';
...
export default function Tryy() {
  ...
  return (
    <div className='bodystyle'>
      ...
      <nav>
        <div className="container">
          ...
          <div className="create">
            <label className="btn btn-primary" htmlFor="create-post" onClick={handleDonation}>Donate</label>
      ...
      >
        <span><NotificationsOutlined/><small className="notification-count">9+</small></span> <h3>Notifications</h3>
        {showNotifications && (
          <div className="notifications-popup">
            <div>
              ...
              <div className="notification-body">
                <b>ACN Philippines</b> updated the following donations!
      ...
      <a 
        ...
        <span><BookmarkBorderOutlined/></span> <h3>Bookmarks</h3><span></span>
      </a>
      <a
        id="theme"
